...
app.post("/send-link", async (req, res) => {
  ...
  <div style="font-family:sans-serif;max-width:480px;margin:auto;padding:32px;background:#fff8f8;border-radius:12px;border:1px solid #fde8e8;">
    ...
    <a href="${link}" style="display:inline-block;margin:24px 0;background:#e11d48;color:#fff;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:bold;font-size:16px;">Create my card ✨</a>
    <p style="color:#aaa;font-size:12px;"><a href="${link}">This link</a> expires after use. If you didn't request this, ignore this email.</p>
